...
% linear regression models to it. Make sure to use rng(1998) prior to
...
% Repeat a)-g) with different noise levels by sampling from N=(0,\sigma^2)
% with \sigma={30,60,100} to generate different \eps. Describe your results. 
end